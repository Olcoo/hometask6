...
Vagrant.configure("2") do |config|
  ...
  # boxes at https://vagrantcloud.com/search.
    ...
    config.vm.disk :disk, size: "300MB", name: "extra_disk_1"
    config.vm.disk :disk, size: "300MB", name: "extra_disk_2"
    config.vm.disk :disk, size: "300MB", name: "extra_disk_3"
    config.vm.disk :disk, size: "300MB", name: "extra_disk_4"
  

    config.vm.provision "shell", run: "always", path: "extra_memory.sh"
